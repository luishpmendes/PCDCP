...
int main (int argc, char * argv[]) {
    ...
    ofstream objValFile ("./output/N" + N + "D" + D + "K" + K + "T" + T + "I" + I + "A" + A + "/objVal.txt", ofstream :: out);
    ...
    ofstream elapsedTimeFile ("./output/N" + N + "D" + D + "K" + K + "T" + T + "I" + I + "A" + A + "/elapsedTime.txt", ofstream :: out);
