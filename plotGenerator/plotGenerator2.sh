                    ...
                    do
                        ...
                        do
                            ...
                            do
                                ...
                                rm -f "../geneticAlgorithm/output/N"$n"D"${d//.}"K"$k"T"$t"P"${p//.}"I"$i"PS"$ps"MR"${mr//.}"/graph.pdf";
                                ./plotGenerator "geneticAlgorithm" $n ${d//.} $k $t ${p//.} $i $ps ${mr//.};
                                gnuplot -e "path = 'geneticAlgorithm'; n='${n}'; d='${d}'; k='${k}'; t='${t}'; p='${p}'; D='${d//.}'; P='${p//.}'; i='$i'; ps='$ps'; MR='${mr//.}';" generator2.plt;
                            done
                        done
                    done
                done
